...
3. **GitOps Trigger:** Atualiza a tag da imagem no repositório de infraestrutura [`my-project-gitops-manifests`](https://github.com/marlon-gaules/my-project-gitops-manifests).
